    ...
    <>
      ...
      <main>
        ...
        <Typography variant="body1" className={classes.root}>
          It's a little service that emails you regularly to remind you to check
          in on your friends.
        </Typography> */}

        {/* <Typography variant="h3" aria-label="title">
          What's this whole site?
        </Typography> */}

        <Typography variant="body1" className={classes.root}>
          This whole site is me making stuff I like.
        </Typography>

        <Typography variant="body1" className={classes.root}>
          I do this in my spare time. Maybe late at night after work. Maybe on a
          Sunday afternoon.
        </Typography>
        ...
        <Typography variant="body1" className={classes.root}>
          So, if you're using this and experience a problem, don't complain or
          hate me. Tell me nicely. Or, even better, offer to code up solutions
          instead. Send pull requests to my git repo.
        </Typography>
